  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      <div className='absolute z-50 flex top-2 right-16 gap-4 ' onClick={() => setC((prevState) => { console.log(prevState); return prevState + 1 })}>
        <div className='z-auto p-2 text-lg font-bold text-white bg-yellow-500 cursor-pointer shadow-btn-shadow transform duration-500 ease-in-out hover:scale-105'><a href="https://www.thapar.edu" target="_blank">   Learn More</a></div>
